...
class BrowserFragmentTest : BaseTests() {

    private val presenter by before { mock<BrowserPresenter>() }
    ...
    private val fragment by before {
        spy(BrowserFragment()) {
            ...
            presenter = this@BrowserFragmentTest.presenter
        }
    }
    ...
    fun `fragment robolectric tests required`() {
        Assert.fail("Fragment unit tests have not been implemented for Browser. Replace this method with actual tests.")
    }
}