...
class SigningFragmentTest : BaseTests() {

    private val presenter by before { mock<SigningPresenter>() }
    ...
    private val fragment by before {
        spy(SigningFragment()) {
            ...
            presenter = this@SigningFragmentTest.presenter
        }
    }
    ...
    fun `fragment robolectric tests required`() {
        Assert.fail("Fragment unit tests have not been implemented for Signing. Replace this method with actual tests.")
    }
}