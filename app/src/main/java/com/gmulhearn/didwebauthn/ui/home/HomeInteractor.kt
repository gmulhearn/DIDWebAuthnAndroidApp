...
/**
 * Home VIPER Interactor Implementation
 */
...
class HomeInteractor @Inject constructor(
    ...
    internal val router: HomeRouter,
    private val walletProvider: WalletProvider
) : HomeContract.InteractorInput, CoroutineScope by coroutineScope {

    internal val outputDelegate = ObjectDelegate<HomeContract.InteractorOutput>()
    ...
    override fun attachOutput(output: HomeContract.InteractorOutput) {
